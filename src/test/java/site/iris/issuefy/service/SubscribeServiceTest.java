...
class SubscribeServiceTest {
    ...
    void addSubscribeRepository() {
        ...
        when(repositoryRepository.findByOrgIdAndName(org.getId(), repositoryUrlDto.getRepositoryName())).thenReturn(Optional.of(repository));
        when(userRepository.findByGithubId(repositoryUrlDto.getGithubId())).thenReturn(Optional.of(user));
        when(subscribeRepository.findByUserIdAndRepositoryId(user.getId(), repository.getId())).thenReturn(Optional.of(subscribe));
